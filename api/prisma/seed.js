...
async function main() {
    ...
    const specializations = await Promise.all(specializationData.map((s) => prisma.specialization.upsert({
        where: { name: s.name },
        update: {},
        create: s,
    })));
    ...
    const appointmentSeeds = [
        {
            ...
            startTime: '09:00',
            endTime: '10:00',
            type: client_1.AppointmentType.PHYSICAL,
        ...
        },
        {
            ...
            startTime: '10:00',
            endTime: '11:00',
            type: client_1.AppointmentType.ONLINE,
            status: client_1.AppointmentStatus.COMPLETED,
    ...
    const completedAppointments = appointments.filter((a) => a.status === client_1.AppointmentStatus.COMPLETED);
    const reviewData = [
    ...
    const diarySeeds = [
        {
            lawyerId: lawyerProfiles[0].id,
            type: client_1.DiaryEntryType.HEARING,
            status: client_1.DiaryStatus.OPEN,
        ...
        {
            lawyerId: lawyerProfiles[0].id,
            type: client_1.DiaryEntryType.TASK,
            status: client_1.DiaryStatus.IN_PROGRESS,
        ...
        {
            lawyerId: lawyerProfiles[1].id,
            type: client_1.DiaryEntryType.CASE,
            status: client_1.DiaryStatus.IN_PROGRESS,
        ...
        {
            lawyerId: lawyerProfiles[3].id,
            type: client_1.DiaryEntryType.REMINDER,
            status: client_1.DiaryStatus.OPEN,
    ...
    await prisma.firmMember.upsert({
        ...
        update: {},
        create: { firmId: firm.id, lawyerId: lawyerProfiles[0].id, role: client_1.FirmMemberRole.OWNER },
    });
    if (fatimaProfile) {
        await prisma.firmMember.upsert({
            where: { firmId_lawyerId: { firmId: firm.id, lawyerId: fatimaProfile.id } },
            update: {},
            create: { firmId: firm.id, lawyerId: fatimaProfile.id, role: client_1.FirmMemberRole.ASSOCIATE },
        });
    }
    ...
    const caseSeeds = [
        {
            ...
            caseType: client_1.CaseType.FAMILY,
            status: client_1.CaseStatus.HEARING_SCHEDULED,
            courtName: 'Family Court Lahore',
            courtCity: 'Lahore',
            courtProvince: client_1.CourtProvince.PUNJAB,
            courtType: client_1.CourtType.FAMILY,
        ...
        },
        {
            ...
            caseType: client_1.CaseType.CORPORATE,
            status: client_1.CaseStatus.IN_PROGRESS,
            courtName: 'Commercial Court Karachi',
            courtCity: 'Karachi',
            courtProvince: client_1.CourtProvince.SINDH,
            courtType: client_1.CourtType.HIGH,
        ...
        },
        {
            ...
            caseType: client_1.CaseType.CRIMINAL,
            status: client_1.CaseStatus.IN_PROGRESS,
            courtName: 'Sessions Court Peshawar',
            courtCity: 'Peshawar',
            courtProvince: client_1.CourtProvince.KPK,
            courtType: client_1.CourtType.DISTRICT,
        ...
        },
        {
            ...
            caseType: client_1.CaseType.PROPERTY,
    ...
    const hearingSeeds = [
        {
            ...
            status: client_1.HearingStatus.SCHEDULED,
        },
        {
            caseId: cases[0].id,
            ...
            courtRoom: 'Court Room 3',
            judge: 'Honorable Justice Ayesha Siddiqa',
            status: client_1.HearingStatus.HELD,
        ...
        },
        {
            ...
            courtRoom: 'Sessions Court 2',
            judge: 'Honorable ASJ Imran Shah',
            status: client_1.HearingStatus.ADJOURNED,
    ...
    const docSeeds = [
        {
            ...
            category: client_1.DocumentCategory.PETITION,
        ...
        },
        {
            ...
            category: client_1.DocumentCategory.VAKALATNAMA,
            fileUrl: 'https://res.cloudinary.com/demo/raw/upload/sample.pdf',
            fileType: 'application/pdf',
        ...
        },
        {
            ...
            category: client_1.DocumentCategory.FIR,
            fileUrl: 'https://res.cloudinary.com/demo/raw/upload/sample.pdf',
            fileType: 'application/pdf',
            fileSizeBytes: 51200,
            isSharedWithClient: true,
